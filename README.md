...
* Shibsankar Das and **Virendra Kumar**. [Investigation of Closed Derivation Formulas for GQ and QG Indices of a Graph via M-polynomial](https://ijmc.kashanu.ac.ir/article_112048.html). [*Iranian Journal of Mathematical Chemistry (IJMC)*](https://ijmc.kashanu.ac.ir/), Volume **13**, Issue no. 2, Pages 129 - 144, 2022, (Accepted on 13-May-2022). [DOI: [https://doi.org/10.22052/ijmc.2022.246172.1614](https://doi.org/10.22052/ijmc.2022.246172.1614)]  - [ISSN: 1560-7534] - [Indexed in **Scopus, ESCI (Web of Science), Q2**].

* Shibsankar Das and **Virendra Kumar**. [On M-Polynomial of the Two-dimensional Silicon-Carbons](https://pjm.ppu.edu/sites/default/files/papers/PJM_Speciall_Issue_II_March_2022_136_to_157.pdf). [*Palestine Journal of Mathematics*](https://pjm.ppu.edu/), Volume **11**, Issue no. Special Issue II, Pages 136 - 157, 2022, (Accepted on 14-September-2021). [ISSN: 2219-5688] - [Indexed in American Math Reviews, **Scopus**, Q4].
...
- Participated and presented a paper entitled *Topological Characterization of Some Silicon Carbide Networks using GQ and QG Indices‑based Entropy Measures* at the 5th **International Conference on Mathematical, Engineering and Management Sciences (5th ICMEMS 2024)**, during December 13‑14, 2024, organized by Applied Science Cluster (Mathematics), School of Advanced Engineering, UPES, Dehradun, Uttarakhand, India.
- Presented a paper entitled *Predictive Potential of the Nirmala Index and its Comparison with the Sombor Index Through QSPR Analysis* at the **International Conference on Applied Mathematics (ICAM2024)** from 27‑28 June 2024, organized by the Department of Applied Mathematics, Vidyasagar University, Midnapore‑721102, West Bengal, India.
- Participated in the **International Conference & Symposium on AI Advancements in Hyperbolic and Parabolic PDEs (ICS‑AIPDEs23)** jointly organized by the Department of Mathematics, University of Calicut, India and Department of Mathematical Sciences, UNIST, Republic of Korea during October 20‑22, 2023.
- Taken part in **2023 Ural workshop on Group Theory and Combinatorics (2023UWGTC)** and have given a contributed talk on the topic *A Novel Approach to Compute the Sombor‑type indices via M‑polynomial*. 2023UWGTC was held on August 21‑27, 2023 (Yekaterinburg‑Online, Russia) and was organized by The Institute of Natural Sciences and Mathematics of the Ural Federal University, N.N. Krasovskii Institute of Mathematics and Mechanics UB RAS, and The Ural Mathematical Center.
- Presented a research paper entitled *On Nirmala Indices‑Based Entropy Measures of Silicon Carbide Network* in the **International Conference on Graphs, Networks and Combinatorics (ICGNC 2023)** organized by the Department of Mathematics, Ramanujan College, University of Delhi during 10‑12 January, 2023.
